...
Version  : 1.29
Release  : 25
URL      : ftp://ftp.gnupg.org/gcrypt/libgpg-error/libgpg-error-1.29.tar.gz
Source0  : ftp://ftp.gnupg.org/gcrypt/libgpg-error/libgpg-error-1.29.tar.gz
Source99 : ftp://ftp.gnupg.org/gcrypt/libgpg-error/libgpg-error-1.29.tar.gz.sig
...
%prep
%setup -q -n libgpg-error-1.29
pushd ..
cp -a libgpg-error-1.29 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1523463840
...
/usr/lib32/libgpg-error.so.0.24.0
