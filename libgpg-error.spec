...
Source0  : ftp://ftp.gnupg.org/gcrypt/libgpg-error/libgpg-error-1.26.tar.bz2
...
%prep
%setup -q -n libgpg-error-1.26
pushd ..
cp -a libgpg-error-1.26 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1483293151
...
/usr/lib64/libgpg-error.so.0.21.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgpg-error.so.0
/usr/lib32/libgpg-error.so.0.21.0
